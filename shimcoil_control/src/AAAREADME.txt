...
On the server machine, you need to install wxpython. for simple GUI and run the ControlShim.py
...
if you want to control the program from labview, you will need to send the Controller program the right characters.